...
#$ -o /home/uctpln0/FruitDemand/code/fortran/output/A24_20170516D.out
#$ -N A24D
#$ -j y
#$ -cwd
#$ -l tmem=4G,h_vmem=4G
...
date
which mpirun
mpirun --mca btl_tcp_if_include 10.0.0.0/8 -np $NSLOTS SparseDemand_mpi.exe ../inputs/A24/A24D.prop
date
