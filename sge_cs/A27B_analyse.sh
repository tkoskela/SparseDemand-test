...
#$ -o /home/uctpln0/FruitDemand/code/fortran/output/A27B_analyse.out
#$ -N A27B_anal
#$ -j y
#$ -cwd
#$ -l tmem=4G,h_vmem=4G
...
date
which mpirun
mpirun --mca btl_tcp_if_include 10.0.0.0/8 -np $NSLOTS SparseDemand_mpi.dbg ../inputs/A27/A27B.prop
date
