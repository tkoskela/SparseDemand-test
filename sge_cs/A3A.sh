...
#$ -o /home/uctpln0/FruitDemand/code/fortran/output/A3A.out
#$ -N A3
#$ -j y
#$ -cwd
#$ -l tmem=4G,h_vmem=4G
...
which mpirun
#mpirun --mca btl_tcp_if_include 10.0.0.0/8 -np $NSLOTS SparseDemand_mpi.exe ../inputs/A3/A3.prop
mpirun --mca btl_tcp_if_include 10.0.0.0/8 --mca mpi_preconnect_mpi 1 -np $NSLOTS SparseDemand_mpi.exe ../inputs/A3/A3.prop
