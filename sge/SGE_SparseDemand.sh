...
#$ -wd /data/uctpln0/IO/Lewbel/code/fortran
 
# Specify an output file
#$ -o /data/uctpln0/IO/Lewbel/code/fortran/output/a30.out
...
module load sge/2011.11 intel/fortran/2011.1.107 nag/f77/fll6i24dc openmpi/intel/64/1.4.5 
echo "Loaded modules"
module list

cd /data/uctpln0/IO/Lewbel/code/fortran
date
mpirun -np $NSLOTS SparseDemand_mpi.exe inputs/A30/A30.prop
date
