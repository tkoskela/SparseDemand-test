function elas = ImportElasticity(filename,J, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   ELAS = IMPORTFILE(FILENAME) Reads data from text file FILENAME for the
%   default selection.
%
%   ELAS = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   elas = importfile('elas.csv', 1, 24);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2016/12/06 23:03:18
