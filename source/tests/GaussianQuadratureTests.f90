...
module GaussianQuadratureTests
  ...
  subroutine CheckGaussianQuadratureRule(&
  ...
  subroutine TestLegendreRule()
    print "(A)", "Running tests for Legendre quadrature rule"
    call CheckGaussianQuadratureRule(&
  ...
  subroutine TestChebyshev1Rule()
    print "(A)", "Running tests for Chebyshev-1 quadrature rule"
    call CheckGaussianQuadratureRule(&
  ...
  subroutine TestChebyshev2Rule()
    print "(A)", "Running tests for Chebyshev-2 quadrature rule"
    call CheckGaussianQuadratureRule(&
  ...
  subroutine TestHermiteRule()
    print "(A)", "Running tests for Hermite quadrature rule"
    call CheckGaussianQuadratureRule(&
  ...
  subroutine TestLaguerreRule()
    print "(A)", "Running tests for Laguerre quadrature rule"
    call CheckGaussianQuadratureRule(&
  ...
  subroutine TestJacobiRule()
    print "(A)", "Running tests for Jacobi quadrature rule"
  ...
  subroutine TestLegendreRadauRule()
    print "(A)", "Running tests for Legendre Radau quadrature rule"
    call CheckGaussianQuadratureRule(&
  ...
  subroutine TestLegendreLobattoRule()
    print "(A)", "Running tests for Legendre Lobatto quadrature rule"
    call CheckGaussianQuadratureRule(&
